...
class AddCodingDialog(QDialog):
    def __init__(self, language, parent=None):
        ...
        labels_ro = {
            ...
            "module": "Modul",
            "function": "Funcție",
            "fabricatie": "Generație",
            "tool": "Tool",
            "pasi_ro": "Pași în RO (fiecare pe linie nouă)",
            "pasi_en": "Pași în EN (fiecare pe linie nouă)",
            "save": "Salvează"
        }
        labels_en = {
            "model": "Model",
            "module": "Module",
            "function": "Function",
            "fabricatie": "Generation",
            "tool": "Tool",
            "pasi_ro": "Steps in RO (one per line)",
            "pasi_en": "Steps in EN (one per line)",
            "save": "Save"
        }
        ...
        if self.language == "ro":
            ...
            self.fabrication_combo.addItem("Choose generation")
    ...
    def save_data_to_file(self):
        ...
        try:
            DataValidator.validate(self.language,model, fabricatie, modul,
                                   data["functie"], data["tool"], data["pasi_ro"], data["pasi_en"])
        except Exception as e:
