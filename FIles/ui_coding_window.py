...
class BMWCodingGuide(QWidget):
    def __init__(self, language):
        ...
        self.style_label = "font-size: 16px; font-weight: 25"
        self.style_combo = "font-size: 15px; font-weight: 15; height: 32px"
    ...
    def init_ui(self):
        ...
        self.instructions_box.setStyleSheet("font-size: 16px; font-weight: bold")
    ...
    def update_ui_language(self):
        if self.current_language == "ro":
            ...
            self.fabrication_label.setText("Generație:")
            ...
            self.model_label.setText("Model:")
            self.fabrication_label.setText("Generation:")
    ...
    def update_module(self, _=None):
        ...
        if model in self.data and fabric in self.data[model]:
            self.modul_combo.addItems(sorted(self.data[model][fabric].keys()))
    ...
    def update_function(self, _=None):
        ...
        if (
            ...
            self.function_combo.addItems(sorted(self.data[model][fabric][modul].keys()))
